...
[![npm](https://img.shields.io/npm/v/@mithic/react?style=flat-square&logo=npm)](https://www.npmjs.com/package/@mithic/react)
...
> React virtual DOM adapters for mithic

Status: WIP - event subscription not implemented

<br/>

## Install
```shell
npm install --save @mithic/react
```
