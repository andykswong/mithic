...
[![npm](https://img.shields.io/npm/v/@mithic/dom?style=flat-square&logo=npm)](https://www.npmjs.com/package/@mithic/dom)
...
> Virtual DOM API for mithic

<br/>

## Install
```shell
npm install --save @mithic/dom
```
