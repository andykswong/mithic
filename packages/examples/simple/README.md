# Simple WebAssembly Component Example
...
This is a minimal example to show how to build a WebAssembly component on mithic runtime using JavaScript and [ComponentizeJS][https://github.com/bytecodealliance/ComponentizeJS].
