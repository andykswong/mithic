...
describe('batch', () => {
  ...
  describe('getMany', () => {
    it('should return values from bucket', () => {
      const key = 'keyyy';
      expect(getMany(bucket, [key, key2, key3])).toEqual([undefined, [key2, value2], [key3, value3]]);
    });
  });
  ...
  describe('setMany', () => {
    it('should set key values to bucket', () => {
      ...
      expect(getMany(bucket, [key, key1, key2, key3]))
        .toEqual([[key, value], [key1, value1], [key2, newValue2], [key3, value3]]);
    });
  });
  ...
  describe('deleteMany', () => {
    it('should delete keys from bucket', () => {
      ...
      expect(getMany(bucket, [key1, key2, key3])).toEqual([undefined, undefined, [key3, value3]]);
    });
  });
});
