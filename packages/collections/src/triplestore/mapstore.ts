...
import { AttrSearchKey, EntityAttrKey, EntityAttrSearchKey, TripleStore } from '../triplestore.ts';
import { compareMultiKeys } from '../utils/index.ts';
import { BaseTripleStore } from './base.ts';
